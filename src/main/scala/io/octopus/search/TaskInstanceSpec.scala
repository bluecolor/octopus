...
class TaskInstanceSpec(@BeanProperty var criteria: SearchCriteria) extends Specification[TaskInstance] {
  
  override def toPredicate(root: Root[TaskInstance], query: CriteriaQuery[_], builder: CriteriaBuilder): Predicate = {
